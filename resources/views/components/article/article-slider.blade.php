<div class="bg-white rounded-standart px-2 md:px-6 pt-5 pb-8 col-span-2 flex flex-col justify-between row-span-4 mb-10 xl:mb-0 hover:bg-default-hover duration-500 transition ease-in-out">
                ...
                @foreach($articles as $article)
                    @php
                        ...
                        if($article->thumbnail){
                            $img = makeThumbnail('storage/' . $article->thumbnail, '1000x500', 'crop');
                        }
                    @endphp
