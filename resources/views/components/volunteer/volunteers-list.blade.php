                ...
                <div class="flex items-start gap-6">
                    ...
                    <div class="max-h-[84px] max-w-[84px] w-full h-full border-[3px] border-accent-blue p-1 rounded-[50%]">
                        <a href="{{ route('volunteer.show', ['slug' => $volunteer->slug]) }}">
                            <img class="rounded-[50%] h-full w-full" src="/images/volunteers/2.jpg" alt="{{ $volunteer->name }}">
                        </a>    
                    </div>
                </div>
            @else
                <div class="flex items-start gap-6">
                    <div class="max-h-[84px] max-w-[84px] w-full h-full border-[3px] border-accent-blue p-1 rounded-[50%]">
                        <a href="{{ route('volunteer.show', ['slug' => $volunteer->slug]) }}">
                            <img class="rounded-[50%] h-full w-full" src="/images/volunteers/1.jpg" alt="{{ $volunteer->name }}">
                        </a>    
                    </div>
                    <div class="py-1 pb-2">
