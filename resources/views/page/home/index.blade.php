    ...
    <section>
        <div class="container">
            <div class="gap-6 grid-cols-3 grid-rows-8 xl:grid 3xl:grid-rows-5 3xl:grid-cols-4">
                <div class="bg-white rounded-standart px-2 md:px-6 pt-5 pb-8 col-span-1 flex flex-col justify-between row-span-4 mb-10 xl:mb-0 hover:bg-default-hover duration-500 transition ease-in-out">
                ...
                <div class="bg-white rounded-standart px-2 md:px-4 lg:px-6 py-4 col-span-3 flex items-center row-span-2 3xl:row-span-1 hover:bg-default-hover duration-500 transition ease-in-out">
