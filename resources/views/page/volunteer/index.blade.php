            ...
            <div class="bg-white px-2 md:px-6 py-8 rounded-standart">
                ...
                <div class="grid lg:grid-cols-2 xl:grid-cols-3 gap-x-4 gap-y-5">
                    @foreach ($volunteers as $volunteer)
                        ...
                        @endphp
                        <div class="p-4 bg-premium rounded-standart flex gap-3 items-center flex-wrap flex-col md:flex-nowrap justify-center hover:bg-premium-hover duration-500 transition ease-in-out">
